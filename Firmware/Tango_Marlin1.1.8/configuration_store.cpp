...
extern float z_values[GRID_MAX_POINTS_X][GRID_MAX_POINTS_Y],zprobe_baby_stepping;
...
{/*
    SERIAL_PROTOCOLPGM("s1:");
     SERIAL_PROTOCOL(LOGICAL_X_POSITION(bilinear_grid_spacing[0]));
    SERIAL_PROTOCOLPGM("s2:");
     SERIAL_PROTOCOL(LOGICAL_X_POSITION(bilinear_grid_spacing[1]));
    SERIAL_PROTOCOLPGM("s3:");
     SERIAL_PROTOCOL(LOGICAL_X_POSITION(bilinear_start[0]));
    SERIAL_PROTOCOLPGM("s4:");
     SERIAL_PROTOCOL(LOGICAL_X_POSITION(bilinear_start[1]));

     print_bilinear_leveling_grid();
        */
   _EEPROM_writeData(600,(uint8_t*)&bilinear_grid_spacing[0],sizeof(bilinear_grid_spacing));
   _EEPROM_writeData(600+sizeof(bilinear_grid_spacing),(uint8_t*)&bilinear_start[0],sizeof(bilinear_start));
   _EEPROM_writeData(600+sizeof(bilinear_grid_spacing)+sizeof(bilinear_start),(uint8_t*)&z_values[0][0],sizeof(z_values));
}
void readLevelingPara(void)
{
   _EEPROM_readData(600,(uint8_t*)&bilinear_grid_spacing[0],sizeof(bilinear_grid_spacing));
   _EEPROM_readData(600+sizeof(bilinear_grid_spacing),(uint8_t*)&bilinear_start[0],sizeof(bilinear_start));
   _EEPROM_readData(600+sizeof(bilinear_grid_spacing)+sizeof(bilinear_start),(uint8_t*)&z_values[0][0],sizeof(z_values));

/*
     SERIAL_PROTOCOLPGM("rs1:");
     SERIAL_PROTOCOL(LOGICAL_X_POSITION(bilinear_grid_spacing[0]));
    SERIAL_PROTOCOLPGM("rs2:");
     SERIAL_PROTOCOL(LOGICAL_X_POSITION(bilinear_grid_spacing[1]));
    SERIAL_PROTOCOLPGM("rs3:");
     SERIAL_PROTOCOL(LOGICAL_X_POSITION(bilinear_start[0]));
    SERIAL_PROTOCOLPGM("rs4:");
     SERIAL_PROTOCOL(LOGICAL_X_POSITION(bilinear_start[1]));
     print_bilinear_leveling_grid();
     */
}
...
{
  _EEPROM_writeData(1000,(uint8_t*)&zprobe_baby_stepping,sizeof(zprobe_baby_stepping));    
}
void readBabyStepping(void)
{
  _EEPROM_readData(1000,(uint8_t*)&zprobe_baby_stepping,sizeof(zprobe_baby_stepping));    
}
#endif
